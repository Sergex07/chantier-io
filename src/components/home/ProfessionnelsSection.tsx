          ...
          <div key={p.name} className="cursor-pointer group">
            <div className="relative h-56 w-full rounded-2xl overflow-hidden bg-[#eee]">
              <Image
                ...
                unoptimized
              />
              <div className="absolute top-3 left-3 bg-black/60 text-white text-[0.7rem] font-bold px-[10px] py-1 rounded-full">
                {p.badge}
              </div>
            ...
            <div className="pt-3 px-1">
              <div className="flex items-start justify-between gap-2">
                <div className="text-[0.9rem] font-semibold text-[#18170F]">{p.name}</div>
              ...
              <div className="text-[0.875rem] text-[#18170F] mt-[6px]">{p.cat}</div>
            </div>
          </div>
        ))}
      </div>
