  ...
  return (
    ...
    >
      <div style={{ height: 224, background: d.bg, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <span style={{ fontSize: d.initiales.length > 2 ? '2.2rem' : '3rem', fontWeight: 900, color: 'white', letterSpacing: '-0.02em' }}>{d.initiales}</span>
      </div>
    ...
    <section style={{ padding: '0 40px 64px', background: '#fff' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#18170F', letterSpacing: '-0.03em' }}>Détaillants en vedette</h2>
          <a href="#" style={{ fontSize: '0.875rem', color: '#18170F', fontWeight: 600, textDecoration: 'underline', textUnderlineOffset: 3 }}>Voir tous les détaillants →</a>
        </div>
