export default function TravailleurHeroSection() {
  ...
  return (
    <section style={{ background: 'white', borderBottom: '1px solid #F0EEEA' }}>
      {/* Bande décorative */}
      <div style={{ height: '4px', background: 'linear-gradient(90deg, #4A5568, #718096, #4A5568)' }} />
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto',
          ...
          <div>
            <div style={{
              ...
              border: '1px solid #DBEAFE', borderRadius: '100px',
              fontSize: '0.72rem', fontWeight: 600, color: '#2563EB', marginBottom: '20px',
            }}>
            ...
            <h2 style={{ fontSize: '2rem', fontWeight: 500, color: '#18170F',
              ...
              Votre profil construction<span style={{ color: '#4A5568' }}>.</span><br />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            {features.map((f, i) => (
              <div key={i} style={{
                ...
                border: '1px solid #F0EEEA', background: 'white',
