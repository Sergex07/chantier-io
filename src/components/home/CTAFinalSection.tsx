  ...
  return (
    <div style={{ background: '#4A5568', padding: '96px 40px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        <h2 style={{ fontSize: 'clamp(2rem, 3.8vw, 3rem)', fontWeight: 800, letterSpacing: '-0.04em', color: 'white', lineHeight: 1.1, marginBottom: '16px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
          <a href="/inscription" style={{ background: 'white', color: '#18170F', fontSize: '0.95rem', fontWeight: 700, padding: '13px 28px', borderRadius: '10px', textDecoration: 'none', display: 'inline-block' }}>
            Créer mon compte gratuitement →
          </a>
          <a href="#" style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.95rem', fontWeight: 500, padding: '13px 20px', borderRadius: '10px', textDecoration: 'none', display: 'inline-block' }}>
            Voir une démo ↗
          </a>
        </div>
      </div>
